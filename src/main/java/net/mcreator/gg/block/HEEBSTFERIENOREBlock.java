...
public class HEEBSTFERIENOREBlock extends GgModElements.ModElement {
	@ObjectHolder("gg:heebstferienore")
	public static final Block block = null;
	public HEEBSTFERIENOREBlock(GgModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("heebstferienore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("heebstferienore", "heebstferienore", blockAt -> {
