...
public class HEEBSTFERIENBlock extends GgModElements.ModElement {
	@ObjectHolder("gg:heebstferien")
	public static final Block block = null;
	public HEEBSTFERIENBlock(GgModElements instance) {
		super(instance, 1);
	}
